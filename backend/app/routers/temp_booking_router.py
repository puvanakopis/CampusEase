...
from app.services.temp_booking_service import create_or_update_temp_booking, get_temp_booking_by_user, delete_temp_booking
...
@router.get("/", response_model=Optional[TempBookingResponse])
