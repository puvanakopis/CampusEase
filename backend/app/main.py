...
from app.routers import auth_router, accommodation_router,vehicle_router,owner_router,user_router, save_item_router, accommodation_booking_router
...
app.include_router(accommodation_booking_router.router)
