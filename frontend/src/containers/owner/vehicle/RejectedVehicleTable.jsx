...
const RejectedVehicleTable = ({ vehicles, handleViewVehicle, handleEditBeforeResubmit, handleDeleteVehicle, loading }) => {
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
            <div className="px-6 py-4 border-b border-slate-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <h3 className="text-lg font-bold text-slate-900">Rejected Vehicles ({filteredVehicles.length})</h3>
                ...
                <table className="w-full text-left border-collapse">
                    <thead className="bg-slate-50">
                        <tr>
                            ...
                            <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Rejection Info</th>
                            <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Admin Remarks</th>
                                ...
                                <td className="px-6 py-4">
                                    <div className="space-y-1">
                                        <p className="text-xs">
                                            ...
                                            <span className="text-slate-700 ml-1">{formatDate(vehicle.last_updated || vehicle.rejectedDate)}</span>
                                        </p>
                                ...
                                <td className="px-6 py-4">
                                    <div className="bg-red-50 p-3 rounded-lg">
                                        <p className="text-xs text-red-700 font-medium mb-1">
                                            {vehicle.reject_reason || vehicle.rejectionReason}
                                        </p>
                                        {vehicle.adminRemarks && (
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex flex-col gap-2 items-center">
                                        ...
                                        <div className="flex gap-2 w-full">
                                            <button
                                                onClick={() => handleEditBeforeResubmit(vehicle)}
                            ...
                            <tr>
                                <td colSpan="5" className="px-6 py-12 text-center">
                                    <div className="text-slate-400">
                                        ...
                                        <p className="text-sm">No rejected vehicles</p>
