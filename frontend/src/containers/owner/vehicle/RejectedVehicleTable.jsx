...
const RejectedVehicleTable = ({ vehicles, handleViewVehicle, handleEditBeforeResubmit, handleDeleteVehicle }) => {
    return (
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
            <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center">
                <h3 className="text-lg font-bold text-slate-900">Rejected Vehicles ({vehicles.length})</h3>
                                ...
                                <td className="px-6 py-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs">
                                            ...
                                            <span className="text-slate-700 ml-1">{vehicle.rejectedDate}</span>
                                        </p>
