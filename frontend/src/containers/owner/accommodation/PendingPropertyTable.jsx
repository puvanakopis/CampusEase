...
const PendingPropertyTable = ({ properties, onView, onEdit, onDelete }) => {
    return (
                                ...
                                <td className="px-6 py-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs">
                                            ...
                                            <span className="text-slate-700 ml-1">{property.expectedResponseDate}</span>
                                        </p>
                            ...
                            <tr>
                                <td colSpan="5" className="px-6 py-12 text-center">
                                    <div className="text-slate-400">
                                        ...
                                        <p className="text-sm">No pending properties</p>
