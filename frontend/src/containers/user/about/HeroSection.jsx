...
function HeroSection() {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-background-light py-8 md:py-8 lg:py">
            <div className="max-w-[1200px] mx-auto px-4 sm:px-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="z-10">
