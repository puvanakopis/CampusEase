        ...
        <section className="py-20 bg-white">
            <div className="px-4 md:px-10 max-w-7xl mx-auto mx-auto px-4 sm:px-10">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="w-20 h-1 bg-primary/90 mx-auto mb-8 rounded-full"></div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-left">
                        <div className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                            <span className="material-symbols-outlined text-primary/90 text-3xl shrink-0">home_work</span>
                            <div>
                        ...
                        <div className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                            <span className="material-symbols-outlined text-primary/90 text-3xl shrink-0">commute</span>
                            <div>
