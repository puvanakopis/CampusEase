...
const BookingCard = ({ month_rent, rating, paymentDetails, owner, available_users, total_users }) => {
            ...
            <div className="sticky top-28 bg-white border border-slate-200 rounded-xl shadow-sm p-6">
                <div className="flex items-baseline justify-between mb-6">
                    <div className="flex items-baseline gap-1">
                        <span className="text-2xl font-bold text-slate-900">{currency} {month_rent.toLocaleString()}</span>
                ...
                <div className="border border-slate-300 rounded-lg mb-4 overflow-hidden">
                    ...
                    <div className="p-3 hover:bg-slate-50 cursor-pointer">
                        ...
                        <div className="text-sm text-slate-600 mt-0.5">{available_users} of {total_users} SUSL Student{total_users > 1 ? 's' : ''}</div>
                    </div>
                </div>
