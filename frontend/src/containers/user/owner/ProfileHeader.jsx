        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
            <div className="relative flex flex-col md:flex-row items-end gap-6 pb-6 border-b border-slate-200">
                ...
                <div className="flex gap-2 pb-2">
                    <button className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-white border border-slate-200 font-bold text-sm shadow-sm hover:bg-slate-50 transition-colors">
