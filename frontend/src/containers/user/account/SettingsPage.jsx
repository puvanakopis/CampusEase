            ...
            <div className="space-y-6">
                ...
                <section className="space-y-4">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                        {/* Booking Updates */}
                        <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 last:border-b-0">
                            <div className="flex flex-col">
                                <span className="text-sm font-medium text-slate-900">Booking Updates</span>
                        ...
                        <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 last:border-b-0">
                            <div className="flex flex-col">
                                <span className="text-sm font-medium text-slate-900">Transport Alerts</span>
                                <span className="text-xs text-slate-500">
                        ...
                        <div className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            <div className="flex flex-col">
                                <span className="text-sm font-medium text-slate-900">Promotions</span>
                                <span className="text-xs text-slate-500">
