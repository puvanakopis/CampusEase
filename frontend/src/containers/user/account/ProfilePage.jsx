    ...
    return (
        <div className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-10">
            <div className="space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            {currentUser?.description && (
                                <p className="text-sm text-slate-600 mt-2 italic">{currentUser.description}</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-6">
                    <h3 className="text-lg font-bold text-slate-900 mb-4">Personal Details</h3>
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Fourth Row: University ID and Role */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">
                                    University ID
